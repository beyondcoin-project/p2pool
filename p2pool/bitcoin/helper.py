...
def getwork(bitcoind, use_getblocktemplate=False):
    ...
    try:
        ...
        try:
            ...
            print >>sys.stderr, 'Error: Beyondcoin version too old! Upgrade to v0.15.2 or newer!'
            raise deferral.RetrySilentlyException()
...
def submit_block_rpc(block, ignore_failure, bitcoind, bitcoind_work, net):
    ...
    if bitcoind_work.value['use_getblocktemplate']:
        ...
        except jsonrpc.Error_for_code(-32601): # Method not found, for older beyondcoin versions
